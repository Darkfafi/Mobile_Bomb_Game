...
:: Android packaging
set AND_CERT_NAME="BombDefuseGame"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\BombDefuseGame.p12
...
set IOS_PROVISION=cert\BombDefuseGame.mobileprovision
...
set APP_ID=air.BombDefuseGame

:: Output packages
set DIST_PATH=dist
set DIST_NAME=BombDefuseGame
